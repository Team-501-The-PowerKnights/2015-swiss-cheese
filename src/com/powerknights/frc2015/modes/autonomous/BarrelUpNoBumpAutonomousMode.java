...
public class BarrelUpNoBumpAutonomousMode
   extends LifterAutonomousMode
{
    ...
    * @param robot
    **/
   public BarrelUpNoBumpAutonomousMode( RobotBase robot )
   {
      super( robot );
   ...
   {
      System.out
         .println( "Autonomous with barrel pick up, no bump implementation" );
      lcdManager.logMessage( "Autonomous - BarrelUpNoBump" );
